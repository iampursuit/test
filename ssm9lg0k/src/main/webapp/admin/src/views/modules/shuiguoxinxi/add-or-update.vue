<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="水果分类" prop="shuiguofenlei">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="水果详情" prop="shuiguoxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shuiguoxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shuiguoxiangqing" label="水果详情" prop="shuiguoxiangqing">
                    <span v-html="ruleForm.shuiguoxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='shuiguoxiangqing'){
            this.ruleForm.shuiguoxiangqing = obj[o];
	    this.ro.shuiguoxiangqing = true;
            continue;
          }
          if(o=='clicktime'){
	...
	this.ruleForm.shuiguoxiangqing = this.ruleForm.shuiguoxiangqing.replace(reg,'../../../ssm9lg0k/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
