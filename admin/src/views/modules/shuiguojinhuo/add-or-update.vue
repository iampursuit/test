<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="进货单号" prop="jinhuodanhao">
            <el-input v-model="ruleForm.jinhuodanhao" 
                placeholder="进货单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jinhuodanhao" label="进货单号" prop="jinhuodanhao">
              <el-input v-model="ruleForm.jinhuodanhao" 
                placeholder="进货单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="水果名称" prop="shuiguomingcheng">
          <el-input v-model="ruleForm.shuiguomingcheng" 
              placeholder="水果名称" clearable  :readonly="ro.shuiguomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="水果名称" prop="shuiguomingcheng">
              <el-input v-model="ruleForm.shuiguomingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="水果分类" prop="shuiguofenlei">
          <el-input v-model="ruleForm.shuiguofenlei" 
              placeholder="水果分类" clearable  :readonly="ro.shuiguofenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="水果分类" prop="shuiguofenlei">
              <el-input v-model="ruleForm.shuiguofenlei" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进货价" prop="jinhuojia">
          <el-input v-model="ruleForm.jinhuojia" 
              placeholder="进货价" clearable  :readonly="ro.jinhuojia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="进货价" prop="jinhuojia">
              <el-input v-model="ruleForm.jinhuojia" 
                placeholder="进货价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="供应商编号" prop="gongyingshangbianhao">
          <el-select  @change="gongyingshangbianhaoChange" v-model="ruleForm.gongyingshangbianhao" placeholder="请选择供应商编号">
            <el-option
                v-for="(item,index) in gongyingshangbianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.gongyingshangbianhao" label="供应商编号" prop="gongyingshangbianhao">
...
export default {
  ...
  computed: {
    zongjine:{
      get: function () {
        return 1*this.ruleForm.shuliang*this.ruleForm.jinhuojia
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jinhuodanhao'){
            this.ruleForm.jinhuodanhao = obj[o];
	    this.ro.jinhuodanhao = true;
            continue;
          }
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='jinhuojia'){
            this.ruleForm.jinhuojia = obj[o];
	    this.ro.jinhuojia = true;
            continue;
          }
          if(o=='zongjine'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/gongyingshang/gongyingshangbianhao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.gongyingshangbianhaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    // 下二随
    gongyingshangbianhaoChange () {
      this.$http({
        url: `follow/gongyingshang/gongyingshangbianhao?columnValue=`+ this.ruleForm.gongyingshangbianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shuiguojinhuo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shuiguojinhuoCrossAddOrUpdateFlag = false;
                  this.parent.search();
